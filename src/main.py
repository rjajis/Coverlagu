...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--pitch-change', type=float, required=True, help='Change the pitch of AI Vocals only. Generally, use 1 for male to female and -1 for vice-versa. (Octaves)')
